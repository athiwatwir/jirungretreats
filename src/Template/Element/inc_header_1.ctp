            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
                    <ul id="js-scroll-nav" class="navbar-nav text-uppercase g-font-weight-700 g-font-size-15 g-pt-20 g-pt-0--lg ml-auto">
                        ...
                        <li class="nav-item g-ml-15--lg <?=($c=='management'?'active':'')?>">
                            <?=$this->Html->link('Management',['controller'=>'management'],['class'=>'nav-link p-0'])?>
                        </li>
                        <li class="nav-item g-ml-15--lg <?=($c=='signin'?'active':'')?>">
                            <?=$this->Html->link('Sign In',['controller'=>'signin'],['class'=>'nav-link p-0'])?>
                        </li>
                    </ul>
                </div>
                <!-- End Navigation -->
